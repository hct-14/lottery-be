...
public class DatabaseInitalizer implements CommandLineRunner {
    ...
    private final PermissionReponsetory permissionRepository;

    private final RoleReponsetory roleRepository;
    private final UserReponsetory userRepository;
    private final PasswordEncoder passwordEncoder;

    public DatabaseInitalizer(PermissionReponsetory permissionRepository, RoleReponsetory roleRepository, UserReponsetory userRepository, PasswordEncoder passwordEncoder) {
